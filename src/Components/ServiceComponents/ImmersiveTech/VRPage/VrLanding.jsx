...
>
  ...
  <br />
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-indigo-500 font-semibold mt-6 inline-block">
    VIRTUAL REALITY
  </span>
</motion.h1>
      ...
      <motion.p
        ...
        className="mt-6 hidden sm:block text-base md:text-sm text-gray-300 max-w-2xl text-center px-6"
