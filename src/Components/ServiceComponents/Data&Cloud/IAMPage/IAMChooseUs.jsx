        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            <div className="text-center md:text-left max-w-md">
              <h3 className="text-xl md:text-2xl xl:text-3xl font-semibold text-[#FDC700] mb-2 sm:mb-3" style={{ fontFamily: "DeaconTest, sans-serif" }}>
                {step.title}
              </h3>
              <p className="text-gray-300 text-base md:text-sm xl:text-lg leading-relaxed" style={{ fontFamily: "anta, sans-serif" }}>
                {step.description}
              </p>
            </div>
          </motion.div>
