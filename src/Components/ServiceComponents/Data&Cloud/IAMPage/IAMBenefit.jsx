...
// Import Images (relative path inside src/)
import img10X from "/src/assets/IAM/10X_converted.png";
import img5X from "/src/assets/IAM/5x_converted.png";
import img3X from "/src/assets/IAM/3x_converted.png";
import img70 from "/src/assets/IAM/70_converted.png";
  ...
  const benefits = [
    {
      ...
      title: "Enhanced Security Infrastructure",
      description:
        "ThirdVizion implements zero-trust architecture and multi-factor authentication, reducing security breaches by 80%.",
      gradient: "from-yellow-500 to-amber-400",
    },
    {
      icon: img5X,
      ...
      title: "Rapid IAM Deployment",
      description:
        "Our expert team deploys complete IAM solutions in weeks, not months, with automated provisioning and seamless integration.",
      gradient: "from-orange-500 to-yellow-400",
    },
    {
      icon: img3X,
      ...
      title: "Compliance Acceleration",
      description:
        "ThirdVizion ensures GDPR, HIPAA, and SOX compliance with built-in audit trails, access reviews, and automated reporting.",
      gradient: "from-amber-500 to-yellow-300",
    },
    {
      icon: img70,
      ...
      title: "IT Operations Efficiency",
      description:
        "Our managed IAM services reduce password reset tickets and manual tasks, freeing your IT team for strategic work.",
      gradient: "from-lime-500 to-yellow-300",
    },
  ];
  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 py-20 font-inter-tight relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          <h2
            className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tight text-yellow-500 mb-6 leading-tight"
          ...
          >
            We deliver comprehensive IAM solutions that strengthen security,
            streamline operations, and ensure compliance for your business.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => (
            ...
            //     {/* Metric */}
            //     <div className="text-2xl md:text-3xl lg:text-4xl font-black text-yellow-500 mb-4 group-hover:drop-shadow-[0_0_10px_rgba(234,179,8,0.3)] transition-all duration-500">
            //       {benefit.metric}
            //     </div>
            ...
            //     {/* Description */}
            //     <p
            //       className="text-lg text-gray-300 leading-relaxed flex-1"
            //       style={{ fontFamily: "anta, sans-serif" }}
            //     >
            //       {benefit.description}
            //     </p>
