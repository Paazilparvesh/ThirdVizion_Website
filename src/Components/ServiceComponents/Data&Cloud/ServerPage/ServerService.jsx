...
// 🔥 Import Images
import HardwareImg from "/src/assets/server/hardware server.png";
import BuyingGuideImg from "/src/assets/server/buying guide.png";
import CloudImg from "/src/assets/server/cloud.png";
      ...
      <section className="max-w-6xl mx-auto text-center py-16 px-6">
        <TextReveal>
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium mb-2 text-[#05df72]"
