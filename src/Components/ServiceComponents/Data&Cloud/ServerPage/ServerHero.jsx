      ...
      <section className="flex flex-col items-center justify-center text-center px-6 max-w-6xl mx-auto min-h-screen">
        <TextReveal>
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl  font-semibold mb-6 text-[#05df72] tracking-wide"
        ...
        <TextReveal delay={0.2}>
          <motion.p
            ...
            className="text-gray-300  text-base md:text-sm max-w-3xl hidden sm:block mb-8 leading-relaxed FONT-MEDIUM"
