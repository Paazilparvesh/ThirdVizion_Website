                ...
                <div className="bg-[#7C86FF10] backdrop-blur-lg rounded-2xl shadow-[0_0_20px_rgba(124,134,255,0.15)] border border-[#7C86FF30] p-8 md:p-12 hover:border-[#7C86FF40] hover:shadow-[0_0_40px_rgba(124,134,255,0.35)] transition-all duration-300">
                    ...
                    <div className="text-center mb-10">
                        ...
                        >
                            ...
                            is an integrated software platform that manages and automates core business processes across finance, HR, supply chain, manufacturing, and operations
                        </p>
                    </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="relative">
                                <div className="flex items-start space-x-4">
                                    <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#7C86FF] to-[#a9afff] rounded-full flex items-center justify-center text-white font-bold text-xl" style={{ fontFamily: 'DeaconTest, sans-serif' }}>
                                        1
                                    </div>
                                    <div>
                                        <h3 
