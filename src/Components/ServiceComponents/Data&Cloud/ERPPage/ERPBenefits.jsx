    ...
    <section className="relative isolate w-full py-20 overflow-hidden bg-transparent">
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <motion.h2
          ...
          viewport={{ amount: 0.3 }}
          className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-font-semibold leading-[1.05] tracking-tight text-center bg-gradient-to-r from-white via-[#dfe1ff] to-[#a9afff] bg-clip-text text-transparent mb-12"
