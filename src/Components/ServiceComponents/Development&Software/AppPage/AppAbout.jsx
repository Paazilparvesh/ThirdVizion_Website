...
const AppAbout = () => {
  ...
  return (
    <section className="w-full min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 mb-20 font-inter-tight">
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl  font-medium tracking-tight text-[#ff8904] mb-6"   style={{ fontFamily: "DeaconTest, sans-serif" }} >
            Building the Future of Mobile Experiences
          </h2>
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed"    style={{ fontFamily: "anta, sans-serif" }}>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.p
              ...
              At <span className="text-[#ff8904] font-semibold"   style={{ fontFamily: "DeaconTest, sans-serif" }}>ThirdVizion</span>, we specialize in creating 
            ...
            <div className="space-y-6">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[#ff8904] font-semibold text-xl mb-2"  style={{ fontFamily: "DeaconTest, sans-serif" }} >Human-Centered Design</h3>
                    <p className="text-gray-300"  style={{ fontFamily: "anta, sans-serif" }} >We create intuitive, engaging apps that users love to interact with.</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[#ff8904] font-semibold text-xl mb-2"  style={{ fontFamily: "DeaconTest, sans-serif" }} >Future-Ready Technology</h3>
                    <p className="text-gray-300"  style={{ fontFamily: "anta, sans-serif" }} >Leveraging the latest frameworks to build scalable, high-performance apps.</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[#ff8904] font-semibold text-xl mb-2" style={{ fontFamily: "DeaconTest, sans-serif" }} >Collaborative Approach</h3>
                    <p className="text-gray-300"  style={{ fontFamily: "anta, sans-serif" }} >Working closely with your team to bring your vision to life effectively.</p>
                  </div>
                </div>
              </motion.div>
            </div>
