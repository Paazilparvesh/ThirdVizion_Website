  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap- z-20 text-white pointer-events-none">
        ...
        <p className="w-full absolute top-155 md:top-128 lg:top-151 xl:top-151 2xl:top-151 left-1/2 -translate-x-1/2 xl:max-w-4xl 2xl:max-w-2xl text-xl md:text-base lg:text-[12px] 2xl:text-xs text-center text-gray-200 px-20 pointer-events-none">
